...
const PrivateRoute = ({ children }: { children?: React.ReactNode }) => {
  ...
  else if (loading && location.pathname !== '/complete-profile') {
  ...
  else if (user && needsProfileCompletion && location.pathname !== '/complete-profile') {
  ...
  else if (user && !needsProfileCompletion && !activeClinic) {
