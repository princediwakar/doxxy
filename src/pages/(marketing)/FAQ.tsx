...
const FAQHeader = ({ searchTerm, setSearchTerm }) => (
  <Section className="text-center !pt-28 md:!pt-40">
    ...
    <SectionSubtitle>
      Find quick answers to common questions about Doxxy. Can't find what you're looking for? Our support team is here to help.
    </SectionSubtitle>
  ...
  <div className="mb-12">
    ...
    <div className="space-y-4">
      {faqs.map((faq, index) => {
        ...
        return (
          <div key={index} className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200/75 dark:border-gray-700/50 overflow-hidden">
            <button
...
const EmptyState = ({ searchTerm }) => (
  <div className="text-center py-12">
    ...
    <Button asChild className="bg-blue-600 text-white hover:bg-blue-700 rounded-xl px-8 py-3 text-base font-semibold">
