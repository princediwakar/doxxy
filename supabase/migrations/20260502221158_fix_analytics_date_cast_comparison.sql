-- Fix: appointments.date stores values in mixed formats (plain "2026-05-02" or
-- full "2026-05-02 00:00:00+05:30"). generate_series produces date type which casts
-- to text with timezone. Cast both sides to date for a reliable comparison.
