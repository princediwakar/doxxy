-- Migration: Backfill get_appointments_with_details_by_clinic RPC
...
BEGIN
  ...
  SELECT DISTINCT ON (a.id)
    ...
    -- FIXED: Join clinic_members using doctor_id and clinic_id instead of user_id
  ...
  -- FIXED: Join clinic_members using doctor's user_id and appointment's clinic_id
  ...
  ORDER BY a.id, b.created_at DESC; -- Order by appointment id and most recent bill first
END;
$function$
;
