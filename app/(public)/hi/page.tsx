...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'डेटा सिक्योरिटी हमारी सबसे बड़ी प्राथमिकता है। डॉक्सी एंड-टू-एंड एन्क्रिप्शन का इस्तेमाल करता है — ठीक वैसे ही जैसे बैंकिंग ऐप्स करते हैं। आपका सारा डेटा भारत में ही स्टोर होता है, किसी विदेशी सर्वर पर नहीं। हम भारत के डिजिटल पर्सनल डेटा प्रोटेक्शन एक्ट 2023 (DPDP Act) का पूरी तरह पालन करते हैं। आपके मरीज़ों का डेटा सिर्फ आप देख सकते हैं — और सिर्फ वही स्टाफ जिन्हें आप एक्सेस दें। हम किसी भी तीसरे पक्ष को डेटा नहीं बेचते। मेडिकल डेटा की गोपनीयता को लेकर हम बिल्कुल गंभीर हैं।',
      },
    },
  ],
};
