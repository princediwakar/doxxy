...
const lybrateConfig: ComparisonConfig = {
  ...
  comparisonPoints: [
    ...
    { feature: 'Pricing Model', doxxy: 'Pay-per-appointment (₹10/appointment)', competitor: 'Commission-based on consultations', advantage: 'Predictable costs, no hidden commissions', icon: <DollarSign className="h-6 w-6 text-primary" /> },
  ...
  painPointItems: [
    ...
    { title: 'Commission-Based Pricing', competitor: 'Lybrate charges a commission on each consultation, which can eat into your revenue, especially for high-volume practices.', doxxy: "Doxxy's transparent pay-per-appointment model ensures you know exactly what you're paying, with no hidden commissions." },
